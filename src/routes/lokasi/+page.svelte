...
<svelte:head>
	...
	<meta
		name="description"
		content="Lokasi Warung Badiduud (Waroeng Badiduud) di Bogor. Cek alamat lengkap, jam operasional, nomor layanan delivery, dan directions. Nikmati ayam geprek lezat terdekat!"
	/>
	<meta
		name="keywords"
		content="lokasi warung badiduud, lokasi waroeng badiduud, alamat warung badidud, jam buka warung badiduud, delivery warung badiduud, ayam geprek terdekat Bogor, warung badiduud Bogor, lokasi terdekat"
	/>
	...
	<meta property="og:url" content="https://badiduud.boday.my.id/lokasi" />
	<meta property="og:title" content="Lokasi Warung Badiduud - Bogor" />
	<meta
		property="og:description"
		content="Temukan lokasi Warung Badiduud di Bogor. Lihat alamat, jam operasional, dan layanan delivery kami."
	/>
	<meta property="og:image" content="https://badiduud.boday.my.id/og-image.jpg" />

	<!-- Twitter -->
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:url" content="https://badiduud.boday.my.id/lokasi" />
	...
	<!-- Canonical URL -->
	<link rel="canonical" href="https://badiduud.boday.my.id/lokasi" />
	...
	<script type="application/ld+json">
		{
			...
			"url": "https://badiduud.boday.my.id/lokasi",
	...
	<main class="pt-19">
		...
		<section class="py-12">
			<div class="mx-auto max-w-7xl px-6">
				<div
					class="overflow-hidden rounded-3xl bg-gradient-to-br from-gray-200 to-gray-300 shadow-2xl"
				>
					<div class="relative h-[500px] w-full">
						...
						<div
							class="absolute right-6 bottom-6 left-6 rounded-2xl bg-white p-6 shadow-2xl md:right-6 md:left-auto md:w-96"
						>
		...
		<section class="pb-20">
			<div class="mx-auto max-w-4xl px-6">
				...
				<div
					class="group relative overflow-hidden rounded-3xl bg-white shadow-xl transition-all duration-300 hover:shadow-2xl"
				>
					<div class="relative bg-gradient-to-br from-red-600 to-red-700 p-8">
						...
						<div class="relative flex items-center gap-6">
							<div
								class="flex h-20 w-20 items-center justify-center rounded-2xl bg-white/20 shadow-lg backdrop-blur-md"
							>
						...
						<div class="mt-6">
							...
							<div class="grid grid-cols-2 gap-3 sm:grid-cols-3">
								{#each loc.features ?? [] as feature}
									<div
										class="flex items-center gap-3 rounded-xl bg-gray-50 p-4 transition-colors hover:bg-red-50"
									>
										<span class="material-symbols-outlined text-xl text-red-700"
											>{feature.icon}</span
										>
				...
				<div class="grid grid-cols-1 gap-12 lg:grid-cols-1">
					<div>
						...
						<p class="mb-8 text-lg text-gray-400">
							Tidak bisa datang ke outlet? Kami siap antar ke lokasi Anda! Nikmati kelezatan Waroeng
							Badiduud dari kenyamanan rumah Anda.
						</p>
						...
						<div class="mt-8">
							<a
								href="/menu"
								class="inline-flex items-center gap-2 rounded-full bg-white px-8 py-4 text-base font-bold text-red-700 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
							>
			...
			<div class="mx-auto max-w-4xl px-6 text-center">
				...
				<div class="flex flex-wrap justify-center gap-4">
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						class="flex items-center gap-2 rounded-full bg-green-600 px-8 py-4 text-base font-bold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-green-700 hover:shadow-xl"
					>
						<span class="material-symbols-outlined">chat</span>
						WhatsApp
					</a>
